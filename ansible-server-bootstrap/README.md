...
**When to use**: 
    * Right after the bootstrap is finished to apply the full security stack. 
    * Whenever you change a configuration (e.g., adding a new user, updating Nginx templates, or rotating SSH keys). 
